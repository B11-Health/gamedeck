...
<p align="center"><a href="https://www.youtube.com/playlist?list=PLG-ejeCsa-AI"><strong>Start here</strong></a> · <a href="https://www.youtube.com/playlist?list=PLCbffYifS8R8">Watch the 30-second tours</a> · <a href="https://youtu.be/vY-fFVu2ClM">Full tutorial</a> · <a href="docs/E2E_REPORT_1.2.0.md">E2E report</a> · <a href="docs/FULL_QA_2026-08-02.md">Full QA report</a></p>
...
- Unified GameDeck Play sessions across managed console cores and OpenBOR, with centered source-driven aspect ratios, Docked / Fullscreen / Pop-out modes, top-edge fullscreen controls, native single-path audio, and active-session ownership
- First-class OpenBOR catalog discovery with deterministic per-game pack staging, isolated saves/logs, portable engine detection, controller-ready settings, native fullscreen fallback, and active-transfer launch protection
...
Watch the public [GameDeck official motion launch trailer](https://youtu.be/0nCHy9WsEpQ), follow [@PlayGameDeck on YouTube](https://www.youtube.com/@PlayGameDeck), and watch [@playgamedeck on TikTok](https://www.tiktok.com/@playgamedeck).
