...
- Added setup-aware mode recommendations, compact live player slots, one-click game/core ID copying, clipboard invite detection, and a no-scroll active-room layout.
