...
final class SystemRegistry {
    ...
    private static final List<SystemDef> SYSTEMS = Collections.unmodifiableList(Arrays.asList(
        ...
        def("nes", "Nintendo Entertainment System", "NES", "#EF4444", new String[]{"nes"}, new String[]{".nes", ".zip"}, "mesen_libretro"),
        def("fds", "Famicom Disk System", "FDS", "#DC2626", new String[]{"fds"}, new String[]{".fds", ".zip"}, "mesen_libretro"),
        ...
        def("arcade", "FinalBurn Neo", "FBNEO", "#EC4899", new String[]{"fbneo", "neogeo"}, new String[]{".zip", ".7z"}, "fbneo_libretro"),
        def("mame", "MAME", "MAME", "#F43F8F", new String[]{"mame", "arcade"}, new String[]{".zip", ".7z"}, "mame_libretro"),
